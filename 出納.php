...
if ($result && $result->num_rows > 0) {
	...
	* {
    ...
    // 顯示欄位名稱
    echo "<tr>";
      echo "<th>單號</th><th>受款人</th><th>金額</th><th>督導意見</th><th>主任意見</th><th>執行長意見</th><th>董事長意見</th><th>會計意見</th><th>審核狀態</th><th>操作</th>";
    echo "</tr>";
...
// 查詢出納審核意見是否存在
        ...
        $execution_cashier = $db_link_review->query($sql_director_opinion6);
    ...
    if ($execution_Accounting && $execution_Accounting->num_rows > 0) {
        $review_row = $execution_Accounting->fetch_assoc();
