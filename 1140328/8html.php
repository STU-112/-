...
<body>
  <div class="container">
    ...
    <form id="paymentForm" action="8.php" method="POST" enctype="multipart/form-data">
      <!-- 填表人 -->
...
<!-- 金額 -->
  ...
  <script>
    // ...JS 維持原狀，只需改動 togglePaymentFields() 時，不再設定【簽收金額、簽收人、付款金額】為必填...
