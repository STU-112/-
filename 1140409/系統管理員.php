...
<div class="banner">
    ...
    <div class="container">
        ...
        <div class="button-container">
            <button class="button" onclick="location.href='管理註冊名單.php'">帳號密碼管理</button>
            <button class="button" onclick="location.href='註冊html.php'">新增使用者</button>
			<button class="button" onclick="location.href='新增職位html.php'">職位設定</button>
			<button class="button" onclick="location.href='新增部門html.php'">部門設定</button>
			<button class="button" onclick="location.href='0307.html'">報表</button>
        </div>
    </div>
