...
<body>
    <div class="container">
        <h1>搜尋單號</h1>
        <form action="核銷.php" method="POST" id="myForm">
            <input type="text" name="單號" id="單號" placeholder="輸入單號" value="<?php echo htmlspecialchars($單號); ?>">
    ...
    <script>
        ...
        document.getElementById('searchBtn').addEventListener('click', function() {
            let 單號 = document.getElementById('單號').value;
            if (單號.trim() === "") {
                alert("請輸入單號！");
                return;
            }
            ...
            xhr.open("POST", "搜尋單號.php", true); // 後端處理搜尋的 PHP 檔案
            ...
            xhr.send("單號=" + encodeURIComponent(單號));
        });
    </script>
</body>
</html>